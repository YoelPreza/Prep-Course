...
function asAmirror(str) {
  ...
  var arrayFinal = stringtoArray.map(function(ele){
...
if (numeroArray.join('') === numeroArray.reverse().join('')){
  return "Es capicua";
}else{
...
function buscoInterseccion(arreglo1, arreglo2){
  ...
  var set2 = new Set(arreglo2);
    return arreglo1.filter(elemento => set2.has(elemento));
    var comunes = intersection(arreglo1, arreglo2);
